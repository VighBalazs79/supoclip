...
This guide explains how Zyntro is structured and how a task moves through the system.

## High-Level System

Zyntro is a multi-service application built around asynchronous video processing.
...
Zyntro uses Better Auth with Prisma and PostgreSQL.
