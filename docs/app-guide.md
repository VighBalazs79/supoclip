...
This guide explains the visible parts of Zyntro and the main user flows.

## Product Summary

Zyntro turns long-form videos into short clips. Users can:
...
Zyntro uses Better Auth with an email and password flow backed by PostgreSQL through Prisma.
